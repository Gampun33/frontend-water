...
export const DAM_STATION_DATA = [
  { name: "เขื่อนภูมิพล", capacity: 13462 },
  { name: "เขื่อนสิริกิติ์", capacity: 9510 },
  { name: "เขื่อนกิ่วลม", capacity: 106.22 },
  { name: "เขื่อนกิ่วคอหมา", capacity: 170.29 },
  { name: "เขื่อนแม่จาง", capacity: 90 },
  { name: "เขื่อนแม่ขาม", capacity: 90 },
  { name: "เขื่อนป่าสักฯ", capacity: 960 },
  { name: "เขื่อนอุบลรัตน์", capacity: 2431 },
  { name: "อ่างเก็บน้ำแม่ฟ้า", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่อาง", capacity: 90 },
  { name: "อ่างเก็บน้ำห้วยทราย", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ทะ", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ไฮ", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ธิ", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่วะ", capacity: 100 },
  { name: "อ่างเก็บน้ำแม่ทาน", capacity: 90 },
  { name: "อ่างเก็บน้ำห้วยหลวง", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่เรียง", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ทก", capacity: 90 },
  { name: "อ่างเก็บน้ำห้วยสมัย", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่นึง", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ค่อม", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่เฟือง", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ต๋ำน้อย", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ไพร", capacity: 90 },
  { name: "อ่างเก็บน้ำห้วยหลวงวังวัว", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ทรายทายคำ", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่สัน", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ปอน", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ยาว", capacity: 90 },
  { name: "อ่างเก็บน้ำห้วยเกี๋ยง", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่กึ๊ด", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่เลียงพัฒนา", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ต๋ำตอนล่าง", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่อาบ", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่พริก", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่พริก(ผาวิ่งชู้)", capacity: 90 },
  { name: "อ่างเก็บน้ำแม่ล้อหัก", capacity: 90 }
];